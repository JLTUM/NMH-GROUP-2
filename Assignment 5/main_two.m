...
mkdir Plots_five
print(fig_FP,'-dpng',"Plots_five/Floating_Point_Error.png",'-r150');
print(fig_DispError,'-dpng',"Plots_five/Dispersive_Error.png",'-r150');
print(fig_Wiggles,'-dpng',"Plots_five/Wiggles.png",'-r150');